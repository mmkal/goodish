...
- Read the [Awesome manifesto](niiiice.md) and [list guidelines](pull_request_template.md) and ensure your list complies.
...
- You might find [this Yeoman generator](https://github.com/dar5hak/generator-niiiice-list) useful.
